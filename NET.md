...
| 13 | `(768hm->1024)x2->8`   | WDL 0.4, LR 0.001, 80 batches  | `7.49 +- 4.59`      | Same architecture and data as net 12, but with horizontally mirrored features |
| 14 | `(768hm->1024)x2->8`   | WDL 0.4, LR 0.001, 120 batches | `5.00 +- 3.60`      | Same architecture and data as net 13, but with an additional 40 batch fine tuning stage at 0.6 WDL |
