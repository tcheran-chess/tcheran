...
impl Params {
    fn new() -> Self {
        Self {
            ...
            best_move_tm_base: scale_param(best_move_tm_base()),
            best_move_tm_multiplier: scale_param(best_move_tm_multiplier()),
            best_move_tm_min: scale_param(best_move_tm_min()),
